...
| `EXCLUDE_AUTHORS`                    | False    | `""`                    | A comma-separated list of GitHub usernames to exclude from conflict detection. Applied after `FILTER_TEAMS` resolution so team members can opt out without leaving the team. Example: `bot-user`          |

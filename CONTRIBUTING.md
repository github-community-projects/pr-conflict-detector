...
# Contributing to pr-conflict-detector
...
Before you ask a question, it is best to search for existing [Issues](https://github.com/github-community-projects/pr-conflict-detector/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/github-community-projects/pr-conflict-detector/issues/new).
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there is not already a bug report existing for your bug or error in the [bug tracker](https://github.com/github-community-projects/pr-conflict-detector/issues).
...
Please submit a bug report using our [GitHub Issues template](https://github.com/github-community-projects/pr-conflict-detector/issues/new?template=bug_report.yml).
...
- Perform a [search](https://github.com/github-community-projects/pr-conflict-detector/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
Please submit an enhancement suggestion using our [GitHub Issues template](https://github.com/github-community-projects/pr-conflict-detector/issues/new?template=feature_request.yml).

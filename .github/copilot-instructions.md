...
This is a GitHub Action that given an organization or specified repositories, detects potential merge conflicts between open pull requests. It scans PRs and identifies those that would conflict if merged, generating a report. Please follow these guidelines when contributing:
